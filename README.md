...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-12 20:02`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/954dd6cb-967a-48dc-b899-02610ba403f0.git
$ cd 954dd6cb-967a-48dc-b899-02610ba403f0
```
